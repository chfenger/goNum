...
func fun34(x float64) float64 {
	return math.Sqrt(x)
}

func BenchmarkIntegralNewtonCotes(b *testing.B) {
	for i := 0; i < b.N; i++ {
		// goNum.IntegralNewtonCotes(fun34, 0.5, 1.0, 1) //～0.43096
		goNum.IntegralNewtonCotes(fun34, 0.5, 1.0, 3)
	}
}
