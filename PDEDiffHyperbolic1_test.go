...
func fun42_1_phi(x float64) float64 {
	return math.Sin(math.Pi * x)
}

func fun42_1_psi(x float64) float64 {
	return x * (1.0 - x)
}

func fun42_1_u1(t float64) float64 {
	return 0.0
}

func fun42_1_u2(t float64) float64 {
	return 0.0
}

func BenchmarkPDEDiffHyperbolic1(b *testing.B) {
	x42_1 := goNum.NewMatrix(2, 2, []float64{0.0, 0.0, 1.0, 0.6})
	for i := 0; i < b.N; i++ {
		goNum.PDEDiffHyperbolic1(fun42_1_phi, fun42_1_psi, fun42_1_u1, fun42_1_u2, x42_1, 1.0, 0.0, 20, 20)
	}
}
