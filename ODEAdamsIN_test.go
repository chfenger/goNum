...
func fun40_2(x0 goNum.Matrix, i int) float64 {
	switch i {
	case 0:
...
func BenchmarkODEAdamsIN(b *testing.B) {
	x40_2 := goNum.NewMatrix(2, 1, []float64{0.0, 1.0})
	for i := 0; i < b.N; i++ {
		goNum.ODEAdamsIN(fun40_2, x40_2, 1.0, 1e-4, 1, 10)
	}
}
